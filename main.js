...
const handleBlockIP = rateLimit({
    ...
    handler: function (req, res, next) {
        ...
        if (!blockedIPs.includes(ip)) {
            ...
            console.log(`[ NINO LIMIT ] → Đã block IP: ${ip}`);
        }
        next();
    }
});
...
app.get('/', function(req, res) {
   res.sendFile(__dirname + '/index.html');
    ...
    console.log('\x1b[36m=====================================================\n\x1b[38;5;220m[ START ] \x1b[33m→\x1b[38;5;119m Máy chủ NVCHIEN đang chạy trên PORT\x1b[38;5;208m', app.get('port'), '\n\x1b[36m=====================================================\n');
});

var totaltime = (new Date().getTime() - starttime)/1000;
console.log("\x1b[38;5;220m[ NINO-LOADING ] \x1b[33m→\x1b[35m Thời gian khởi động: "+Math.round(totaltime*100)/100+" ms");
